package com.example.projectpetparadisebe.controller.general;


import com.example.projectpetparadisebe.config.TwilioSendSms;
import com.example.projectpetparadisebe.entities.Account;
import com.example.projectpetparadisebe.entities.UserInfo;
import com.example.projectpetparadisebe.enums.ERoleName;
import com.example.projectpetparadisebe.exception.HandleExceptionDemo;
import com.example.projectpetparadisebe.payload.request.AccountLoginRequestDto;
import com.example.projectpetparadisebe.payload.request.SignUpRequest;
import com.example.projectpetparadisebe.payload.response.AccountDto;
import com.example.projectpetparadisebe.payload.response.IGenericResponse;
import com.example.projectpetparadisebe.payload.response.JwtResponse;
import com.example.projectpetparadisebe.repository.AccountRepository;
import com.example.projectpetparadisebe.repository.UserInfoRepository;
import com.example.projectpetparadisebe.security.AccountDetailsService;
import com.example.projectpetparadisebe.security.jwtConfig.JwtUtils;
